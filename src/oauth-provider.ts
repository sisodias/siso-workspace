...
export class SingleUserOAuthProvider implements OAuthServerProvider {
  ...
  constructor(
    ...
    this.allowedResources = new Set([this.resourceServerUrl, ...additionalResources].map(url => url.href));
  ...
  async authorize(
    ...
    if (!params.resource || !this.allowedResources.has(params.resource.href)) {
  ...
  async exchangeAuthorizationCode(
    ...
    if (resource && resource.href !== record.params.resource?.href) {
